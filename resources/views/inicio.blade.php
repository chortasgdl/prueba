				...
				<div class="item-slick1 item1-slick1" style="background-image: url(images/slide1-01.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 animated visible-false" data-appear="zoomIn">
							<!-- Button1 -->
							<a href="{{ asset('catalogo') }} " class="btn1 flex-c-m size1 txt3 trans-0-4">
								Revisar Catalago
							</a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-6 p-t-45 p-b-30">
					<div class="wrap-text-welcome t-center">
						...
						<a href=" {{ asset('acerca-de') }} " class="txt4">
							Our Story
	...
	<div class="section-signup bg1-pattern p-t-85 p-b-85">
		<form class="flex-c-m flex-w flex-col-c-m-lg p-l-5 p-r-5">
			<span class="txt5 m-10">
				COMENTA QUE TE PARECE NUESTRA PAGINA WEB
			</span>
			<!-- Button3 -->
			<a class="btn3 flex-c-m size18 txt11 trans-0-4 m-10" href="{{ route('posts.index') }}">Ir a los comentarios</a>
		</form>
	</div>
